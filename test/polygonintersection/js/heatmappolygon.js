 ...
 * @api
 */
const HeatmapPolygon = function(opt_options) {
...
inherits(HeatmapPolygon, VectorLayer);
...
/**
 * @return {string} Data URL for a polygon.
 * @private
 */
HeatmapPolygon.prototype.createPolygon_ = function(polygon) {
 ...
 * @observable
 */
HeatmapPolygon.prototype.getGradient = function() {
 ...
 * @private
 */
HeatmapPolygon.prototype.handleGradientChanged_ = function() {
 ...
 * @private
 */
HeatmapPolygon.prototype.handleStyleChanged_ = function() {
  this.polygonImage_ = this.createPolygon_();
 ...
 * @private
 */
HeatmapPolygon.prototype.handleRender_ = function(event) {
 ...
 * @observable
 */
HeatmapPolygon.prototype.setGradient = function(colors) {
  this.set(Property.GRADIENT, colors);
};


export default HeatmapPolygon;
